...
contract BEP20Locker4 is ReentrancyGuard, Whitelist {
  ...
  address public wbnb = IPancakeRouter(router).WHT();
  ...
  constructor() public {
    ...
    getPrice(0x64FF637fB478863B7468bc97D30a5bF3A428a1fD);
  }
    ...
    onlyWhitelisted
  {
    ...
    lockprice[_bep20Token] = getPrice(_bep20Token);
  ...
  function withdrawOverPriceWithEncrypt(
    ...
    require(
      getPrice(_bep20Token) >= lockprice[_bep20Token].mul(100),
      "price not arrived"
    );
